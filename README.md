...
* We also implemented an option to use correlation as the measure of "distance". It improves the clustering results in the [SSW study](#advanced-feature-detecting-abnormal-climate-events-identification) later in this page. 
